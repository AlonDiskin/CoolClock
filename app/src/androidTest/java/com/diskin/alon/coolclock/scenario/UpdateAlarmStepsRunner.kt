...
@LargeTest
class UpdateAlarmStepsRunner(scenario: ScenarioConfig?) : GreenCoffeeTest(scenario)  {
    ...
    companion object {
        ...
        fun scenarios(): Iterable<ScenarioConfig> {
            return GreenCoffeeConfig()
                .withFeatureFromAssets("assets/feature/update_existing_alarm.feature")
                .scenarios()
        }
    }
