...
@LargeTest
class ShareCityTimeStepsRunner(scenario: ScenarioConfig?) : GreenCoffeeTest(scenario)  {
    ...
    companion object {
        ...
        fun scenarios(): Iterable<ScenarioConfig> {
            return GreenCoffeeConfig()
                .withFeatureFromAssets("assets/feature/share_city_time.feature")
                .scenarios()
        }
    }
