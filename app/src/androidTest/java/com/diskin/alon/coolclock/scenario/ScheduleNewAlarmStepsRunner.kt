...
@LargeTest
class ScheduleNewAlarmStepsRunner(scenario: ScenarioConfig?) : GreenCoffeeTest(scenario)  {
    ...
    companion object {
        ...
        fun scenarios(): Iterable<ScenarioConfig> {
            return GreenCoffeeConfig()
                .withFeatureFromAssets("assets/feature/schedule_new_alarm.feature")
                .scenarios()
        }
    }
    ...
    fun test() {
        hiltRule.inject()
        start(ScheduleNewAlarmSteps(db))
    }
}