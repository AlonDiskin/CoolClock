...
@LargeTest
class DisableAlarmStepsRunner(scenario: ScenarioConfig?) : GreenCoffeeTest(scenario)  {
    ...
    companion object {
        ...
        fun scenarios(): Iterable<ScenarioConfig> {
            return GreenCoffeeConfig()
                .withFeatureFromAssets("assets/feature/disable_scheduled_alarm.feature")
                .scenarios()
        }
    }
