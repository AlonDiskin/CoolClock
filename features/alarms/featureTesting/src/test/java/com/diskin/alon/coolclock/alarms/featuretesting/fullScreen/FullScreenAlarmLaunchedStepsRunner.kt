...
@MediumTest
class FullScreenAlarmLaunchedStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    fun test() {
        ...
        // Start test
        start(FullScreenAlarmLaunchedSteps(db,alarmManager,audioManager,ringtoneManager,vibrator))
    }
}