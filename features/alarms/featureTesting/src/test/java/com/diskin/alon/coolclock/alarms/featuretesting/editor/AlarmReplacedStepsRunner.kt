...
@MediumTest
class AlarmReplacedStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
...
//    val instantTaskExecutorRule = InstantTaskExecutorRule()
    ...
    fun test() {
        ...
        // Start test
        start(AlarmReplacedSteps(db,alarmManager,ringtoneManager))
    }
}