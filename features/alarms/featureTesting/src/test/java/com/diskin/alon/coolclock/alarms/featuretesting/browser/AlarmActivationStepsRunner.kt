...
@MediumTest
class AlarmActivationStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            val scenarioConfigs = GreenCoffeeConfig()
                .withFeatureFromAssets("feature/alarms_browser.feature")
                .withTags("@set-alarm-activation")
                .scenarios()
...
//    val instantTaskExecutorRule = InstantTaskExecutorRule()
    ...
    fun test() {
        ...
        // Start test
        start(AlarmActivationSteps(db,alarmManager))
    }
}