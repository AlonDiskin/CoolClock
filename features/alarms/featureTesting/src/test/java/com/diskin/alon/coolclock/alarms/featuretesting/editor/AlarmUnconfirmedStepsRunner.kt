...
@MediumTest
class AlarmUnconfirmedStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            val scenarioConfigs = GreenCoffeeConfig()
                ...
                .withTags("@unconfirmed-not-scheduled")
                .scenarios()
...
//    val instantTaskExecutorRule = InstantTaskExecutorRule()
    ...
    fun test() {
        ...
        // Start test
        start(AlarmUnconfirmedSteps(db,alarmManager,ringtoneManager))
    }
}