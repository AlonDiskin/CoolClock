...
@MediumTest
class AlarmUpdatedStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
...
//    val instantTaskExecutorRule = InstantTaskExecutorRule()
    ...
    fun test() {
        ...
        // Start test
        start(AlarmUpdatedSteps(db,alarmManager,ringtoneManager))
    }
}