...
@MediumTest
class NewAlarmScheduledStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
...
//    val instantTaskExecutorRule = InstantTaskExecutorRule()
    ...
    fun test() {
        ...
        // Start test
        start(NewAlarmScheduledSteps(db,alarmManager,ringtoneManager))
    }
}