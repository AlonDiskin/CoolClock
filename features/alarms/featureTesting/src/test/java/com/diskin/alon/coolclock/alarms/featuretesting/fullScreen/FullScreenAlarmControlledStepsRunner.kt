...
@MediumTest
class FullScreenAlarmControlledStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    fun test() {
        ...
        // Start test
        start(FullScreenAlarmControlledSteps(db,alarmManager,audioManager,ringtoneManager,vibrator))
    }
}