...
@MediumTest
class AlarmRemovedStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
...
//    val instantTaskExecutorRule = InstantTaskExecutorRule()
    ...
    fun test() {
        ...
        // Start test
        start(AlarmRemovedSteps(db,alarmManager,ringtoneManager))
    }
}