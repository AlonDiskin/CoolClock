...
@MediumTest
class AlarmControlledStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            val scenarioConfigs = GreenCoffeeConfig()
                .withFeatureFromAssets("feature/alarm_notification.feature")
                .withTags("@alarm-controlled")
                .scenarios()
    ...
    fun test() {
        ...
        // Start test
        start(AlarmControlledSteps(db,alarmManager,audioManager,ringtoneManager,vibrator))
    }
}